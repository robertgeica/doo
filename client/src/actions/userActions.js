...
export const loadUser = () => async (dispatch) => {
  ...
  try {
    ...
    const { data } = await axios.get(`${REACT_APP_SERVER_URL}api/user`);
...
export const login = (email, password) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.post(
      `${REACT_APP_SERVER_URL}api/user/login`,
      { email, password },
      config
    );
...
export const register = (username, email, password) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.post(
      `${REACT_APP_SERVER_URL}api/user/register`,
...
export const sendResetPasswordEmail = (email) => async (dispatch) => {
  try {
    ...
    const res = await axios.patch(`${REACT_APP_SERVER_URL}api/user/resetpassword`, {email}, config);
...
export const resetPassword = (id, token, newPassword) => async (dispatch) => {
  try {
    ...
    const res = await axios.patch(`${REACT_APP_SERVER_URL}api/user/resetpassword/${id}/${token}`, {password: newPassword}, config);
